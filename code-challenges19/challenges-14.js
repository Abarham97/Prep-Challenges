...
const LastWord = (str) => {
    ...
    let search = str.lastIndexOf(' ');
    let word=str.slice(search+ 1);
...
const replaceWords = (str) => {
    // write your code here
    let word=str.split(' ');
    let searchI=word.indexOf('I');
    let searchAm=word.indexOf('am');
    let searchWas=word.indexOf('was');
    if(searchI+1)
    word.splice(searchI,1,'We');
    if(searchAm+1)
    word.splice(searchAm,1,'are');
    if(searchWas+1)
    word.splice(searchWas,1,'were');
