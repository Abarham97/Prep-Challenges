...
const oddFiltration = (arr) => {
    ...
    let resulte =arr.filter(arr=>arr%2!=0)
    return resulte;
}
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
    ...
    let result=arr.filter(arr=>arr.yearsOfExperience>4 && arr.tech=="JS");
    let Output=result.map(function(cv)
    {

            if(cv.firstName !==null&&cv.LastName!==null)
...
const vowelsFiltration = (arr) => {
    // write your code here
    let regEx = /[aeiou]/gi;
    let result= arr.filter(x=>!x.match(regEx));
